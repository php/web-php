? distributions/.new.manual_de.chm
Index: bugs.php
===================================================================
RCS file: /repository/phpweb/bugs.php,v
retrieving revision 1.109
diff -u -r1.109 bugs.php
--- bugs.php	25 Jun 2001 09:10:16 -0000	1.109
+++ bugs.php	25 Jun 2001 11:00:13 -0000
@@ -411,10 +411,13 @@
...
+    // Send doc bugs also to the doc list 
...
+			// mail phpdoc if old or new type is documenation (jeroen)
+			if ($ebug_type == 'Documentation problem'
+				|| $row[1] == 'Documentation problem')
+			{
...
function show_types($first_item,$show_any,$var_name) {
    $items = array ("Any" => "Any",
                    ...
                    "Ovrimos related" => "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ovrimos related",
