...
releases\php80\common_header(
    ...
    'Değişkenler, Union Types, Attributes, Kurucularda Özellik Tanımı, Match Deyimi, Nullsafe Operatorü, ' .
        ...
        <div class="php8-section__content">
            ...
            <div class="php8-footer__content">
                ...
                <p>
                    ...
                    Yeni özellikler ve geriye dönük uyumluluğu etkileyecek değişikliklerin ayrıntılı listesi için
                    göç belgesini inceleyiniz.
                </p>
            </div>
        </div>
    </section>
