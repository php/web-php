...
<section class="php8-section center">
    ...
    <div class="php8-compare">
        <h2 class="php8-h2" id="attributes">
            ატრიბუტები
            <a class="php8-rfc" href="https://wiki.php.net/rfc/attributes_v2">RFC</a> <a class="php8-rfc"
                href="/manual/ka/language.attributes.php">დოკუმენტაცია</a>
        </h2>
        <div class="php8-compare__main">
            <div class="php8-compare__block example-contents">
                <div class="php8-compare__label">PHP 7</div>
                ...
                'class PostsController
{
    ...
    <div class="php8-compare">
        <h2 class="php8-h2" id="constkactor-property-promotion">
            თვისებების განახლება კონსტრუქტორში
            <a class="php8-rfc" href="https://wiki.php.net/rfc/constkactor_promotion">RFC</a> <a class="php8-rfc"
                href="/manual/ka/language.oop5.decon.php#language.oop5.decon.constkactor.promotion">დოკუმენტაცია</a>
        </h2>
        <div class="php8-compare__main">
            <div class="php8-compare__block example-contents">
                <div class="php8-compare__label">PHP 7</div>
  ...
  public function __constkact(
    ...
    <div class="php8-compare">
        <h2 class="php8-h2" id="union-types">
            Union types
            <a class="php8-rfc" href="https://wiki.php.net/rfc/union_types_v2">RFC</a> <a class="php8-rfc"
                href="/manual/ka/language.types.declarations.php#language.types.declarations.union">დოკუმენტაცია</a>
        </h2>
        <div class="php8-compare__main">
            <div class="php8-compare__block example-contents">
                <div class="php8-compare__label">PHP 7</div>
   ...
   */
  public function __constkact($number) {
    $this->number = $number;
  }
}
...
new Number(\'NaN\'); // TypeError'
    ...
    <div class="php8-compare">
        <h2 class="php8-h2" id="match-expression">
            გამოსახულება Match
            <a class="php8-rfc" href="https://wiki.php.net/rfc/match_expression_v2">RFC</a> <a class="php8-rfc"
                href="/manual/ka/control-stkactures.match.php">დოკუმენტაცია</a>
        </h2>
        <div class="php8-compare__main">
            <div class="php8-compare__block example-contents">
                <div class="php8-compare__label">PHP 7</div>
...
<section class="php8-section php8-section_light">
    ...
    <div class="php8-columns">
        <div class="php8-column">
            ...
            <ul>
                ...
                <li>
                    ...
                    <a href="https://externals.io/message/106522">E-mail თემა</a>
                </li>
                <li>
        ...
        <div class="php8-column">
            ...
            <ul>
                <li>
                    კლასი <a href="https://wiki.php.net/rfc/weak_maps">Weak Map</a>
                </li>
                <li>
                    ინტერფეისი <a href="https://wiki.php.net/rfc/stringable">Stringable</a>
                </li>
                <li>
                ...
                <li>
                    ობიექტზე-ორიენტირებული ფუნქცია <a
        ...
        <div class="php8-footer__content">
            <p>
                PHP 8 წყაროს კოდის ჩამოსატვირთად ეწვიეთ <a
                    href="http://www.php.net/downloads">downloads</a>.
            ...
            <p>
                <a href="/manual/ka/migration80.php">მიგრაციის გზამკვლევი</a> ხელმისაწვდომია დოკუმენტაციის განყოფილებაში.
