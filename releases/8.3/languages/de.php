...
return [
    'common_header' => 'PHP 8.3 ist ein Minor-Update der Sprache PHP und beinhaltet viele neue Features und Verbesserungen. Unter anderem die Typisierung von Klassen-Konstanten, das Klonen von Readonly-Properties und die Erweiterungen der Zufallsgeneratoren. Darüber hinaus beinhaltet das Release Performance-Optimierungen, Bug-Fixes und andere Aufräumarbeiten.',
    'documentation' => 'Doc',
    'main_title' => 'Released!',
    'main_subtitle' => 'PHP 8.3 ist ein Minor-Update der Sprache PHP.<br class="display-none-md"> Es beinhaltet viele neue Features und Verbesserungen.<br>Unter anderem die Typisierung von Klassen-Konstanten, das Klonen von Readonly-Properties und die Erweiterungen der Zufallsgeneratoren. Darüber hinaus beinhaltet das Release Performance-Optimierungen, Bug-Fixes und andere Aufräumarbeiten.',
    ...
    'json_validate_description' => '<code>json_validate()</code> ermöglicht das Validieren von JSON-Daten auf eine effizientere Art und Weise als <code>json_decode()</code>.',
    ...
    'randomizer_getbytesfromstring_description' => 'Die <a href="/releases/8.2/en.php#random_extension">Random Erweiterung</a>, welche in PHP 8.2 hinzugefügt wurde, wurde um eine neue Methode Erweitert um einen String zu generieren, welcher nur aus Set von angegebenen Zeichen besteht. Diese Methode erlaubt es den Entwicklern einfach eine zufällige Zeichenfolge zu generieren.',
    'randomizer_getfloat_nextfloat_title' => 'Neue Methoden <code>Randomizer::getFloat()</code> und <code>Randomizer::nextFloat()</code>',
    'randomizer_getfloat_nextfloat_description' => '<p>Durch die limitierte Präzision und der impliziten Rundung von Gleitkommazahlen war das unvoreingenommene Generieren von Gleitkommazahlen nicht einfach.</p><p>Die Randomizer-Erweiterung wurde daher um 2 Methoden erweitert um zufällige und unvoreingenommene Gleitkommazahlen zu generieren. Die <code>Randomizer::getFloat()</code> Methode nutzt den Bisektion Algorithmus, welcher in <a href="https://doi.org/10.1145/3503512" target="_blank" rel="noopener noreferrer">Drawing Random Floating-Point Numbers from an Interval. Frédéric Goualard, ACM Trans. Model. Comput. Simul., 32:3, 2022.</a> veröffentlicht wurde</p>',
    'dynamic_class_constant_fetch_title' => 'Dynamisches abrufen von Klassen-Konstanten',
    'command_line_linter_title' => 'Kommando Zeilen Linter erlaubt mehrere Dateien',
    'command_line_linter_description' => '<p>Der Kommandozeilen Linter erlaubt nun die Angabe von mehreren Dateien.</p>',
