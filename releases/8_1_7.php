<?php
$_SERVER['BASE_PAGE'] = 'releases/8_1_7.php';
include_once __DIR__ . '/../include/prepend.inc';
site_header('PHP 8.1.7 Release Announcement');
?>
<h1>PHP 8.1.7 Release Announcement</h1>

<p>The PHP development team announces the immediate availability of PHP 8.1.7. This is a security release.</p>
