...
remotely. However, some of the above issues can be triggered remotely and in shared hosting environments based on Apache module even local
exploits can present a critical danger. Therefor we strongly advise all users of PHP, regardless of the version to upgrade to 5.2.1 release
as soon as possible.
</p>
...
<ul>
	...
	<li>PDO_MySQL now uses buffered queries by default and emulates prepared statements to bypass limitation of MySQL's prepared statement API.</li>
	...
	<li>Over 180 various bug fixes.</li>
</ul>
