...
return [
    ...
    'bcmath_description' => '<p>BCMath permite que você trabalhe com números de ponto flutuante de precisão arbitrária no PHP. Com esta versão, você pode aproveitar o estilo orientado a objetos e a sobrecarga de operadores para usar números BCMath.</p><p>Isso significa que agora você pode usar operadores padrão com objetos <code>BcMath\Number</code>, que também suportam todas as funções <code>bc*</code>.</p><p>Esses objetos são imutáveis e implementam a interface <code>Stringable</code>, então podem ser usados em contextos de string como <code>echo $num</code>.</p>',
