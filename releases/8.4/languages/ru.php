...
return [
    ...
    'bcmath_description' => '<p>BCMath позволяет работать с числами с плавающей точкой произвольной точности в PHP. В этом выпуске вы можете воспользоваться преимуществами объектно-ориентированного стиля и перегрузки операторов для работы с числами BCMath.</p><p>Теперь можно использовать стандартные операторы с объектами <code>BcMath\Number</code>, которые также поддерживают все функции <code>bc*</code>.</p><p>Эти объекты неизменяемы и реализуют интерфейс <code>Stringable</code>, поэтому их можно использовать в строковых контекстах, например, <code>echo $num</code>.</p>',
