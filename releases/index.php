...
<ul>
 ...
 <li>
  ...
  <ul>
   <li>
    <?php download_link('php-5.2.3.tar.bz2','Source (tar.bz2)'); ?><br />
    <span class="md5sum">md5: eb50b751c8e1ced05bd012d5a0e4dec3</span>
   </li>
   <li>
    <?php download_link('php-5.2.3.tar.gz','Source (tar.gz)'); ?><br />
    <span class="md5sum">md5: df79b04d63fc4c1ccb6d8ea58a9cf3ac</span>
   </li>
   <li>
    <?php download_link('php-5.2.3-Win32.zip','Windows binary'); ?><br />
    <span class="md5sum">md5: ff6e5dc212823009e68f26d66d85cbac</span>
   </li>
   <li>
    <?php download_link('pecl-5.2.3-Win32.zip','Collection of PECL modules for PHP 5.2.3'); ?><br />
    <span class="md5sum">md5: 0480ffaf5a5333e83d90d75cece54748</span>
   </li>
  </ul>
 </li>
</ul>
...
<ul>
 ...
 <li>
  ...
  <ul>
   <li>
    <?php download_link('php-5.2.1.tar.bz2','Source (tar.bz2)'); ?><br />
    <span class="md5sum">md5: 261218e3569a777dbd87c16a15f05c8d</span>
   </li>
   <li>
    <?php download_link('php-5.2.1.tar.gz','Source (tar.gz)'); ?><br />
    <span class="md5sum">md5: 604eaee2b834bb037d2c83e53e300d3f</span>
   </li>
   <li>
    <?php download_link('php-5.2.1-Win32.zip','Windows binary'); ?><br />
    <span class="md5sum">md5: 682dd66fb03c7dd24c522f474e1b04b6</span>
   </li>
   <li>
    <?php download_link('pecl-5.2.1-Win32.zip','Collection of PECL modules for PHP 5.2.1'); ?><br />
...
<ul>
 ...
 <li>
  Download:
    ...
    <a href="http://museum.php.net/win32/php-4.4.5-Win32.zip">Windows binary</a>
 </li>
</ul>
...
<ul>
 ...
 <li>
  Download:
    ...
    <a href="http://museum.php.net/win32/php-4.4.4-Win32.zip">Windows binary</a>
    <a href="http://museum.php.net/win32/php-4.4.4-installer.exe">Windows installer</a>
 </li>
</ul>
...
<ul>
 ...
 <li>
  Download:
    ...
    <a href="http://museum.php.net/win32/php-4.4.3-Win32.zip">Windows binary</a>
    <a href="http://museum.php.net/win32/php-4.4.3-installer.exe">Windows installer</a>
 </li>
</ul>
