...
return [
    ...
    'bc_backtick_operator' => 'Гравис (<code>`</code>) как псевдоним для {0} больше не поддерживается.',
    ...
    'footer_description' => '<p>Для загрузки исходного кода PHP 8.5 посетите страницу <a href="/downloads">Downloads</a>. Бинарные файлы Windows находятся на сайте <a href="https://windows.php.net/download">PHP for Windows</a>. Список изменений перечислен на странице <a href="/ChangeLog-8.php#PHP_8_5">ChangeLog</a>.</p>
        <p><a href="/manual/ru/migration85.php">Руководство по миграции</a> доступно в разделе документации. Ознакомьтесь с ним, чтобы узнать обо всех новых возможностях и изменениях, затрагивающих обратную совместимость.</p>',
];
