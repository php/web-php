...
return [
    ...
    'fibers_content' => '<p>Файберы — это примитивы для реализации облегчённой невытесняющей конкурентности. Они являются средством создания блоков кода, которые можно приостанавливать и возобновлять. Файберы сами по себе не предоставляют возможностей асинхронного выполнения задач. Тем не менее их можно использовать в асинхронных фреймворках и пакетах для упрощения API.</p><p>Посмотрите на приведённый выше пример, как можно переписать код с промисами, если доступны файберы.</p>',
