...
return [
    ...
    'array_unpacking_content' => '<p>PHP раньше поддерживал распаковку массивов с помощью оператора <code>...</code>, но только если массивы были с целочисленными ключами. Теперь можно распаковывать и массивы со строковыми ключами.</p>',
