...
return [
    ...
    'fibers_content' => '<p>Файберы — это примитивы для реализации облегчённой невытесняющей конкурентности. По сути, они являются средством создания блоков кода, которые можно приостанавливать и возобновлять, подобно потокам. Основное отличие в том, что они никогда не прерываются, и выполняются прикладной библиотекой, а не операционной системой.</p>',
