...
<table>
	<tr>
	<td>
		Download <a href="http://www.lerdorf.on.ca/php3/php-3.0a1.tar.gz">PHP 3.0a1</a> (source) from the PHP main site in Toronto, Canada 
	</td>
	<td>
	...
	<tr>
	<td>
		Download <a href="http://php.netvision.net.il/php-3.0a1.tar.gz">PHP 3.0a1</a> (source) from the PHP main site in Netvision, Israel
	</td>
	<td align="center">
	...
	<tr>
	<td>
		Download <a href="http://php.technion.ac.il/php-3.0a1.tar.gz">PHP 3.0a1</a> (source) from the PHP main site in the Technion, Israel
	</td>
	<td align="center">
	...
	<tr>
	<td>
		Download <a href="http://php.guardian.no/php-3.0a1.tar.gz">PHP 3.0a1</a> (source) from the PHP main site in Trondheim, Norway
	</td>
	<td align="center">
		<a href="http://php.guardian.no/php-3.0a1.tar.gz"><img src="gifs/norway.gif" border="0"></a>
	</td>
	</tr>
	<tr>
	<td>
