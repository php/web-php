...
collaborate on a project without having to worry about stepping on each others'
toes.
</p>
<p>
Please note that you do <b>not</b> need a CVS account to <a
href="/anoncvs.php"><b>access</b> the CVS tree</a>, to use PHP, or to write PHP
scripts. You only need a CVS account if you will be a regular contributor to
...
to participate in any discussion your patch generates! Your patch not get
...
<a href="http://www.php.net/manual/admin-notes.php">modify they documentation
...
href="http://www.cvshome.org/">CVShome.org</a>.  This is also where to get the
most recent version of the CVS client.
</p>
<p>
All CVS commit messages get sent to the php-cvs mailing list.  You should
subscribe yourself to this mailing list.  Instructions for subscribing are on
the <a href="/support.php">Support</a> page.
</p>
<p>
...
Substitute your own user name and password for the cvsread/phpfi combination
listed there.  You will not be able to do this until you receive confirmation
of your account having been created.
</p>
