...
setupNavigation(array(
  ...
  'prev' => array('function.filegroup.php3', 'filegroup'),
  'next' => array('function.filemtime.php3', 'filemtime'),
...
manualHeader('fileinode');
?><H1
>fileinode</H1
><P
>fileinode -- get file inode</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int fileinode(string filename);<P
>    Returns the inode number of the file, or false in case of an error.
  
   </P
></DIV
><?php manualFooter('fileinode');?>