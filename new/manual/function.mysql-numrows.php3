...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-numfields.php3', 'mysql_numfields'),
  'next' => array('function.mysql-pconnect.php3', 'mysql_pconnect'),
...
manualHeader('mysql_numrows');
?><H1
>mysql_numrows</H1
><P
>mysql_numrows -- get number of rows in result</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int mysql_numrows(void);<P
>  Identical to <A
HREF="function.mysql-num-rows.php3"
>mysql_num_rows</A
>.</P
></DIV
><?php manualFooter('mysql_numrows');?>