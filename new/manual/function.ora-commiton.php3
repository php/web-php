...
setupNavigation(array(
  ...
  'prev' => array('function.ora-commitoff.php3', 'Ora_CommitOff'),
  'next' => array('function.ora-error.php3', 'Ora_Error'),
...
manualHeader('Ora_CommitOn');
?><H1
>Ora_CommitOn</H1
><P
>Ora_CommitOn -- enable automatic commit</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
