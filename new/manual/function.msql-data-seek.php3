...
setupNavigation(array(
  ...
  'prev' => array('function.msql-createdb.php3', 'msql_createdb'),
  'next' => array('function.msql-dbname.php3', 'msql_dbname'),
...
manualHeader('msql_data_seek');
?><H1
>msql_data_seek</H1
><P
>msql_data_seek -- move internal row pointer</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int msql_data_seek(int result_identifier, int row_number);<P
...
></P
></DIV
><?php manualFooter('msql_data_seek');?>