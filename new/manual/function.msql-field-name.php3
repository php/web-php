...
setupNavigation(array(
  ...
  'prev' => array('function.msql-fetch-row.php3', 'msql_fetch_row'),
  'next' => array('function.msql-field-seek.php3', 'msql_field_seek'),
...
manualHeader('msql_fieldname');
?><H1
>msql_fieldname</H1
><P
>msql_fieldname -- get field name</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
...
> is the field index.
     <TT
CLASS="LITERAL"
>msql_fieldname($result, 2);</TT
> will return
     the name of the second field in the result associated with the
     result identifier.
   </P
></DIV
><?php manualFooter('msql_fieldname');?>