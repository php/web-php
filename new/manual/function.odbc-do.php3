...
setupNavigation(array(
  ...
  'prev' => array('function.odbc-cursor.php3', 'odbc_cursor'),
  'next' => array('function.odbc-exec.php3', 'odbc_exec'),
...
><H2
>Description</H2
>string odbc_do(int conn_id, string query);<P
>     odbc_do will execute a query on the given connection
   </P
></DIV
><?php manualFooter('odbc_do');?>