...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-pconnect.php3', 'mysql_pconnect'),
  'next' => array('function.mysql-result.php3', 'mysql_result'),
...
manualHeader('mysql_query');
?><H1
>mysql_query</H1
><P
>mysql_query -- send MySQL query</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
