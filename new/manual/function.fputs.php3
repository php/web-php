...
setupNavigation(array(
  ...
  'prev' => array('function.fpassthru.php3', 'fpassthru'),
  'next' => array('function.fseek.php3', 'fseek'),
...
>fputs</H1
><P
>fputs -- write to a file pointer</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int fputs(int fp, string str);<P
> 
...
><P
> The file pointer must
     be valid, and must point to a file successfully opened by <A
