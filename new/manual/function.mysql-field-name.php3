...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-fetch-row.php3', 'mysql_fetch_row'),
  'next' => array('function.mysql-field-seek.php3', 'mysql_field_seek'),
...
><H2
>Description</H2
>string mysql_field_name(string result, int i);<P
