...
setupNavigation(array(
  ...
  'prev' => array('function.odbc-connect.php3', 'odbc_connect'),
  'next' => array('function.odbc-do.php3', 'odbc_do'),
...
manualHeader('odbc_cursor');
?><H1
>odbc_cursor</H1
><P
>odbc_cursor -- Get cursorname</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>string odbc_cursor(int result_id);<P
>     odbc_cursor will return a cursorname for the given result_id.
   </P
></DIV
><?php manualFooter('odbc_cursor');?>