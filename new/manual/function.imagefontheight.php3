...
setupNavigation(array(
  ...
  'prev' => array('function.imagefilltoborder.php3', 'ImageFillToBorder'),
  'next' => array('function.imagefontwidth.php3', 'ImageFontWidth'),
...
manualHeader('ImageFontHeight');
?><H1
>ImageFontHeight</H1
><P
>ImageFontHeight -- get font height</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int imagefontheight(int font);<P
...
></DIV
><?php manualFooter('ImageFontHeight');?>