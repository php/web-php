...
setupNavigation(array(
  ...
  'prev' => array('function.msql-pconnect.php3', 'msql_pconnect'),
  'next' => array('function.msql-result.php3', 'msql_result'),
