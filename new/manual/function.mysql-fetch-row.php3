...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-fetch-object.php3', 'mysql_fetch_object'),
  'next' => array('function.mysql-field-name.php3', 'mysql_field_name'),
...
><H2
>Description</H2
>array mysql_fetch_row(int result);<P
...
></P
></DIV
><?php manualFooter('mysql_fetch_row');?>