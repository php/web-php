...
setupNavigation(array(
  ...
  'prev' => array('function.getimagesize.php3', 'GetImageSize'),
  'next' => array('function.imagechar.php3', 'ImageChar'),
...
manualHeader('ImageArc');
?><H1
>ImageArc</H1
><P
>ImageArc -- draw a partial ellipse</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int imagearc(int im, int cx, int cy, int w, int h, int s, int e, int col);<P
