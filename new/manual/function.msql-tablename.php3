...
setupNavigation(array(
  ...
  'prev' => array('function.msql-select-db.php3', 'msql_select_db'),
  'next' => array('ref.mysql.php3', 'MySQL Functions'),
...
manualHeader('msql_tablename');
?><H1
>msql_tablename</H1
><P
>msql_tablename -- get table name of field</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>string msql_tablename(int result, int field);<P
>    
     msql_tablename takes a result pointer returned by the <A
...
><P
><B
>Example 1. msql_tablename() example</B
></P
><PRE
CLASS="PROGRAMLISTING"
>&#60;? msql_connect ("localhost");
   $result = msql_listtables ("wisconsin");
   $i = 0;
...
></DIV
><?php manualFooter('msql_tablename');?>