...
setupNavigation(array(
  ...
  'prev' => array('function.fgetc.php3', 'fgetc'),
  'next' => array('function.fgetss.php3', 'fgetss'),
...
>fgets</H1
><P
>fgets -- get line from file pointer</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>string fgets(int fp, int length);<P
>    
