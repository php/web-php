...
setupNavigation(array(
  ...
  'prev' => array('function.msql-fetch-object.php3', 'msql_fetch_object'),
  'next' => array('function.msql-field-name.php3', 'msql_fieldname'),
...
manualHeader('msql_fetch_row');
?><H1
>msql_fetch_row</H1
><P
>msql_fetch_row -- get row as enumerated array</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>array msql_fetch_row(int result);<P
...
><P
>  
  Subsequent call to msql_fetch_rows() would return
...
></DIV
><?php manualFooter('msql_fetch_row');?>