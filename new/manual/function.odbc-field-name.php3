...
setupNavigation(array(
  ...
  'prev' => array('function.odbc-fetch-row.php3', 'odbc_fetch_row'),
  'next' => array('function.odbc-field-num.php3', 'odbc_field_num'),
...
manualHeader('odbc_field_name');
?><H1
>odbc_field_name</H1
><P
>odbc_field_name -- Get the columnname</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
