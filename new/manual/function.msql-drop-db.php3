...
setupNavigation(array(
  ...
  'prev' => array('function.msql-dbname.php3', 'msql_dbname'),
  'next' => array('function.msql-fetch-array.php3', 'msql_fetch_array'),
...
manualHeader('msql_drop_db');
?><H1
>msql_drop_db</H1
><P
>msql_drop_db -- drop (delete) mSQL database</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int msql_drop_db(string database_name, int link_identifier);<P
>     Returns true on success, false on failure.
    </P
><P
>  
  msql_drop_db() attempts to drop (remove) an entire
