...
setupNavigation(array(
  ...
  'prev' => array('lang-syntax08.php3', 'Type juggling'),
  'next' => array('lang-const.php3', 'Language constructs'),
...
manualHeader('Array manipulation');
?><H1
><A
NAME="I(LANG-SYNTAX)C(9,SECT1)"
>Array manipulation</A
></H1
><P
></P
><?php manualFooter('Array manipulation');?>