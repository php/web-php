...
setupNavigation(array(
  ...
  'prev' => array('function.msql-data-seek.php3', 'msql_data_seek'),
  'next' => array('function.msql-drop-db.php3', 'msql_drop_db'),
...
><H2
>Description</H2
>string msql_dbname(string result, int i);<P
>     msql_dbname returns the database name stored in position $i of
     the result pointer returned from the <A
...
>msql_numrows</A
> function
     can be used to determine how many database names are available.

    </P
><P
>     msql_dbname returns the database name stored in position i of the
     result pointer returned from the <A
HREF="function.msql-listdbs.php3"
>msql_listdbs</A
>
     function. The <A
