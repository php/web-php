...
setupNavigation(array(
  ...
  'prev' => array('function.msql-create-db.php3', 'msql_create_db'),
  'next' => array('function.msql-data-seek.php3', 'msql_data_seek'),
...
manualHeader('msql_createdb');
?><H1
>msql_createdb</H1
><P
>msql_createdb -- create mSQL database</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int msql_createdb(void);<P
>  Identical to <A
HREF="function.msql-create-db.php3"
>msql_create_db</A
>.</P
></DIV
><?php manualFooter('msql_createdb');?>