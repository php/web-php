...
setupNavigation(array(
  ...
  'prev' => array('function.imagestring.php3', 'ImageString'),
  'next' => array('function.imagesx.php3', 'ImageSX'),
...
manualHeader('ImageStringUp');
?><H1
>ImageStringUp</H1
><P
>ImageStringUp -- draw a string vertically</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int imagestringup(int im, int font, int x, int y, string s, int col);<P
...
></DIV
><?php manualFooter('ImageStringUp');?>