...
setupNavigation(array(
  ...
  'prev' => array('function.imagearc.php3', 'ImageArc'),
  'next' => array('function.imagecharup.php3', 'ImageCharUp'),
...
manualHeader('ImageChar');
?><H1
>ImageChar</H1
><P
>ImageChar -- draw a character horizontally</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int imagechar(int im, int font, int x, int y, string c, int col);<P
