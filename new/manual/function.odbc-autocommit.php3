...
setupNavigation(array(
  ...
  'prev' => array('ref.odbc.php3', 'ODBC Functions'),
  'next' => array('function.odbc-close.php3', 'odbc_close'),
...
manualHeader('odbc_autocommit');
?><H1
>odbc_autocommit</H1
><P
>odbc_autocommit -- Toggle autocommit behaviour</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
...
></DIV
><?php manualFooter('odbc_autocommit');?>