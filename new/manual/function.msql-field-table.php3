...
setupNavigation(array(
  ...
  'prev' => array('function.msql-field-seek.php3', 'msql_field_seek'),
  'next' => array('function.msql-field-type.php3', 'msql_fieldtype'),
...
manualHeader('msql_fieldtable');
?><H1
>msql_fieldtable</H1
><P
>msql_fieldtable -- get table name for field</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int msql_fieldtable(int result, int field);<P
>     Returns the name of the table <TT
CLASS="PARAMETER"
><I
>field</I
></TT
...
></DIV
><?php manualFooter('msql_fieldtable');?>