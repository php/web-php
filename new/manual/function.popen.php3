...
setupNavigation(array(
  ...
  'prev' => array('function.pclose.php3', 'pclose'),
  'next' => array('function.readfile.php3', 'readfile'),
...
>popen</H1
><P
>popen -- open process file pointer</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int popen(string command, string mode);<P
> Opens a pipe to a process executed by forking the command
    given by command.

    </P
><P
> Returns a file pointer identical to that returned by <A
HREF="function.fopen.php3"
>fopen</A
>, except
    that it is unidirectional (may only be used for reading or
    writing) and must be closed with <A
HREF="function.pclose.php3"
>pclose</A
>. This pointer may be used
    with <A
