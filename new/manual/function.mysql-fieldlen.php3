...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-fieldflags.php3', 'mysql_fieldflags'),
  'next' => array('function.mysql-freeresult.php3', 'mysql_freeresult'),
...
><H2
>Description</H2
>int mysql_fieldlen(string result, int i);<P
>   mysql_fieldlen returns the length of the specified field.
  </P
></DIV
><?php manualFooter('mysql_fieldlen');?>