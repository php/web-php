...
setupNavigation(array(
  ...
  'prev' => array('function.imagecreate.php3', 'ImageCreate'),
  'next' => array('function.imagedashedline.php3', 'ImageDashedLine'),
...
manualHeader('ImageCreateFromGif');
?><H1
>ImageCreateFromGif</H1
><P
>ImageCreateFromGif -- create a new image from file or URL</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int imagecreatefromgif(string filename);<P
>    ImageCreateFromGif returns an image identifier representing the
    image obtained from the given filename.
   </P
></DIV
><?php manualFooter('ImageCreateFromGif');?>