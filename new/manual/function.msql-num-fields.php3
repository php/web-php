...
setupNavigation(array(
  ...
  'prev' => array('function.msql-listtables.php3', 'msql_listtables'),
  'next' => array('function.msql-num-rows.php3', 'msql_num_rows'),
...
manualHeader('msql_num_fields');
?><H1
>msql_num_fields</H1
><P
>msql_num_fields -- get number of fields in result</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
...
></DIV
><?php manualFooter('msql_num_fields');?>