...
setupNavigation(array(
  ...
  'prev' => array('function.touch.php3', 'touch'),
  'next' => array('function.dirname.php3', 'dirname'),
...
manualHeader('basename');
?><H1
>basename</H1
><P
>basename -- return file name part of path</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>string basename(string path);<P
