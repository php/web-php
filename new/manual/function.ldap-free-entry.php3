...
setupNavigation(array(
  ...
  'prev' => array('function.ldap-first-entry.php3', 'ldap_first_entry'),
  'next' => array('function.ldap-free-result.php3', 'ldap_free_result'),
...
manualHeader('ldap_free_entry');
?><H1
>ldap_free_entry</H1
><P
>ldap_free_entry -- Free entry result memory</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int ldap_free_entry(int result_entry_identifier);<P
...
></DIV
><?php manualFooter('ldap_free_entry');?>