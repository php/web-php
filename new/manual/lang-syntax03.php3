...
setupNavigation(array(
  ...
  'prev' => array('lang-syntax02.php3', 'Instruction separation'),
  'next' => array('lang-syntax04.php3', 'Variable initialization'),
...
manualHeader('Variable types');
?><H1
><A
NAME="I(LANG-SYNTAX)C(3,SECT1)"
>Variable types</A
></H1
><P
></P
><?php manualFooter('Variable types');?>