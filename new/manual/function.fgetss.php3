...
setupNavigation(array(
  ...
  'prev' => array('function.fgets.php3', 'fgets'),
  'next' => array('function.file.php3', 'file'),
...
>fgetss</H1
><P
>fgetss -- get line from file pointer and strip HTML tags</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>string fgetss(int fp, int length);<P
>     Identical to <A
