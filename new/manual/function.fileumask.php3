...
setupNavigation(array(
  ...
  'prev' => array('function.filetype.php3', 'filetype'),
  'next' => array('function.fopen.php3', 'fopen'),
...
manualHeader('fileumask');
?><H1
>fileumask</H1
><P
>fileumask -- get file umask</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int fileumask(int umask);<P
