...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-fetch-lengths.php3', 'mysql_fetch_lengths'),
  'next' => array('function.mysql-fetch-row.php3', 'mysql_fetch_row'),
...
manualHeader('mysql_fetch_object');
?><H1
...
></P
></DIV
><?php manualFooter('mysql_fetch_object');?>