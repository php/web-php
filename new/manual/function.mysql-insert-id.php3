...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-freeresult.php3', 'mysql_freeresult'),
  'next' => array('function.mysql-list-fields.php3', 'mysql_list_fields'),
...
><H2
>Description</H2
>int mysql_insert_id(void);<P
>    mysql_insert_id() returns the ID generated for an AUTO_INCREMENTED
...
></DIV
><?php manualFooter('mysql_insert_id');?>