...
setupNavigation(array(
  ...
  'prev' => array('function.odbc-result-all.php3', 'odbc_result_all'),
  'next' => array('ref.oracle.php3', 'Oracle functions'),
...
manualHeader('odbc_rollback');
?><H1
>odbc_rollback</H1
><P
>odbc_rollback -- Rollback a transaction</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int odbc_rollback(int connection_id);<P
