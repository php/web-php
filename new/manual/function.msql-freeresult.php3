...
setupNavigation(array(
  ...
  'prev' => array('function.msql-fieldlen.php3', 'msql_fieldlen'),
  'next' => array('function.msql-list-fields.php3', 'msql_list_fields'),
...
manualHeader('msql_freeresult');
?><H1
>msql_freeresult</H1
><P
>msql_freeresult -- free result memory</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
...
></DIV
><?php manualFooter('msql_freeresult');?>