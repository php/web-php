...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-create-db.php3', 'mysql_create_db'),
  'next' => array('function.mysql-data-seek.php3', 'mysql_data_seek'),
...
manualHeader('mysql_createdb');
?><H1
>mysql_createdb</H1
><P
>mysql_createdb -- create MySQL database</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int mysql_createdb(void);<P
>  Identical to <A
HREF="function.mysql-create-db.php3"
>mysql_create_db</A
>.</P
></DIV
><?php manualFooter('mysql_createdb');?>