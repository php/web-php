...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-fetch-field.php3', 'mysql_fetch_field'),
  'next' => array('function.mysql-fetch-object.php3', 'mysql_fetch_object'),
...
manualHeader('mysql_fetch_lengths');
?><H1
...
><H2
>Description</H2
>int mysql_fetch_lengths(int result);<P
...
></P
></DIV
><?php manualFooter('mysql_fetch_lengths');?>