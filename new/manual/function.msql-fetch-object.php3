...
setupNavigation(array(
  ...
  'prev' => array('function.msql-fetch-field.php3', 'msql_fetch_field'),
  'next' => array('function.msql-fetch-row.php3', 'msql_fetch_row'),
...
manualHeader('msql_fetch_object');
?><H1
>msql_fetch_object</H1
><P
>msql_fetch_object -- fetch row as object</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int msql_fetch_object(int result);<P
>     Returns an object with properties that correspond to the fetched
    row, or false if there are no more rows.
    </P
><P
>  
  msql_fetch_object() is similar to <A
...
></DIV
><?php manualFooter('msql_fetch_object');?>