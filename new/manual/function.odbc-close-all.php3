...
setupNavigation(array(
  ...
  'prev' => array('function.odbc-close.php3', 'odbc_close'),
  'next' => array('function.odbc-commit.php3', 'odbc_commit'),
...
manualHeader('odbc_close_all');
?><H1
>odbc_close_all</H1
><P
>odbc_close_all -- Close all ODBC connections</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
...
></DIV
><?php manualFooter('odbc_close_all');?>