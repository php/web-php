...
setupNavigation(array(
  ...
  'prev' => array('lang-syntax03.php3', 'Variable types'),
  'next' => array('lang-syntax05.php3', 'Variable Scope'),
...
manualHeader('Variable initialization');
?><H1
><A
NAME="I(LANG-SYNTAX)C(4,SECT1)"
>Variable initialization</A
></H1
><P
></P
><?php manualFooter('Variable initialization');?>