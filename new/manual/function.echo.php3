...
setupNavigation(array(
  ...
  'prev' => array('function.chr.php3', 'Chr'),
  'next' => array('function.explode.php3', 'explode'),
...
>echo</H1
><P
>echo -- output one or more strings</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>echo(string arg1, string argn...);<P
