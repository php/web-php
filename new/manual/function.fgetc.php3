...
setupNavigation(array(
  ...
  'prev' => array('function.feof.php3', 'feof'),
  'next' => array('function.fgets.php3', 'fgets'),
...
>fgetc</H1
><P
>fgetc -- get character from file pointer</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>string fgetc(int fp);<P
>    
