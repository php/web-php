...
setupNavigation(array(
  ...
  'prev' => array('function.msql-connect.php3', 'msql_connect'),
  'next' => array('function.msql-createdb.php3', 'msql_createdb'),
...
manualHeader('msql_create_db');
?><H1
>msql_create_db</H1
><P
>msql_create_db -- create mSQL database</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int msql_create_db(void);<P
...
></P
></DIV
><?php manualFooter('msql_create_db');?>