...
setupNavigation(array(
  ...
  'prev' => array('function.imageinterlace.php3', 'ImageInterlace'),
  'next' => array('function.imageloadfont.php3', 'ImageLoadFont'),
...
manualHeader('ImageLine');
?><H1
>ImageLine</H1
><P
>ImageLine -- draw a line</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int imageline(int im, int x1, int y1, int x2, int y2, int col);<P
>    ImageLine draws a line from x1,y1 to
    x2,y2 (top left is
