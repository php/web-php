...
setupNavigation(array(
  ...
  'prev' => array('function.fputs.php3', 'fputs'),
  'next' => array('function.ftell.php3', 'ftell'),
...
>fseek</H1
><P
>fseek -- seek on a file pointer</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int fseek(int fp, int offset);<P
...
><P
>     May not be used on file pointers returned by <A
