...
setupNavigation(array(
  ...
  'prev' => array('function.implode.php3', 'implode'),
  'next' => array('function.print.php3', 'print'),
...
>Ord</H1
><P
>Ord -- return ASCII value of character</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int ord(string string);<P
>     Returns the ASCII value of the first character of string.  This
     function complements <A
