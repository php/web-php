...
setupNavigation(array(
  ...
  'prev' => array('function.file.php3', 'file'),
  'next' => array('function.filectime.php3', 'filectime'),
...
manualHeader('fileatime');
?><H1
>fileatime</H1
><P
>fileatime -- get last access time of file</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int fileatime(string filename);<P
> Returns the time the file was last accessed, or false in case
    of an error.
    
   </P
></DIV
><?php manualFooter('fileatime');?>