...
setupNavigation(array(
  ...
  'prev' => array('function.ada-numrows.php3', 'ada_numrows'),
  'next' => array('function.ada-resultall.php3', 'ada_resultall'),
...
><H2
>Description</H2
>string ada_result(int result_id, mixed field);<P
