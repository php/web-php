...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-connect.php3', 'mysql_connect'),
  'next' => array('function.mysql-createdb.php3', 'mysql_createdb'),
...
><H2
>Description</H2
>int mysql_create_db(void);<P
>  mysql_create_db() attempts to create a new database on
...
></P
></DIV
><?php manualFooter('mysql_create_db');?>