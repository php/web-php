...
setupNavigation(array(
  ...
  'prev' => array('function.ldap-next-entry.php3', 'ldap_next_entry'),
  'next' => array('function.ldap-search.php3', 'ldap_search'),
...
manualHeader('ldap_read');
?><H1
>ldap_read</H1
><P
>ldap_read -- Read an entry</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int ldap_read(int link_identifier, string base_dn, string filter);<P
