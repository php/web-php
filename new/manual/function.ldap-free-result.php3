...
setupNavigation(array(
  ...
  'prev' => array('function.ldap-free-entry.php3', 'ldap_free_entry'),
  'next' => array('function.ldap-get-attributes.php3', 'ldap_get_attributes'),
...
></DIV
><?php manualFooter('ldap_free_result');?>