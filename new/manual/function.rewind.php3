...
setupNavigation(array(
  ...
  'prev' => array('function.rename.php3', 'rename'),
  'next' => array('function.rmdir.php3', 'rmdir'),
...
>rewind</H1
><P
>rewind -- rewind the position of a file pointer</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int rewind(int fp);<P
>    Sets the file position indicator for fp to the
