...
setupNavigation(array(
  ...
  'prev' => array('function.atan.php3', 'Atan'),
  'next' => array('function.ceil.php3', 'Ceil'),
...
>BinDec</H1
><P
>BinDec -- binary to decimal</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int bindec(string binary_string);<P
