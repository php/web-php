...
setupNavigation(array(
  ...
  'prev' => array('function.imagedestroy.php3', 'ImageDestroy'),
  'next' => array('function.imagefilledpolygon.php3', 'ImageFilledPolygon'),
...
manualHeader('ImageFill');
?><H1
>ImageFill</H1
><P
>ImageFill -- flood fill</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int imagefill(int im, int x, int y, int col);<P
>    ImageFill performs a flood fill starting at coordinate x, y (top left is 0,0) with color col in the image im.
   </P
></DIV
><?php manualFooter('ImageFill');?>