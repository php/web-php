...
setupNavigation(array(
  ...
  'prev' => array('function.set-time-limit.php3', 'set_time_limit'),
  'next' => array('function.chdir.php3', 'chdir'),
...
manualHeader('Directory Functions');
?><H1
><A
NAME="REF.DIR"
...
></DT
></DL
><?php manualFooter('Directory Functions');?>