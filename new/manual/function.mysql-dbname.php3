...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-data-seek.php3', 'mysql_data_seek'),
  'next' => array('function.mysql-drop-db.php3', 'mysql_drop_db'),
...
><H2
>Description</H2
>string mysql_dbname(string result, int i);<P
...
>   mysql_dbname returns the database name stored in position
   i
 of the result pointer returned from the <A
HREF="function.mysql-listdbs.php3"
>mysql_listdbs</A
> function. The <A
HREF="function.mysql-numrows.php3"
