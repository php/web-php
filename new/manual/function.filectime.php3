...
setupNavigation(array(
  ...
  'prev' => array('function.fileatime.php3', 'fileatime'),
  'next' => array('function.filegroup.php3', 'filegroup'),
...
manualHeader('filectime');
?><H1
>filectime</H1
><P
>filectime -- get inode modification time of file</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int filectime(string filename);<P
>    Returns the time the file was last changed, or false in case of an
    error.
  
   </P
></DIV
><?php manualFooter('filectime');?>