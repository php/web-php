...
setupNavigation(array(
  ...
  'prev' => array('function.msql-fetch-array.php3', 'msql_fetch_array'),
  'next' => array('function.msql-fetch-object.php3', 'msql_fetch_object'),
...
manualHeader('msql_fetch_field');
?><H1
>msql_fetch_field</H1
><P
>msql_fetch_field -- get field information</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>object msql_fetch_field(int result, int field_offset);<P
...
></DIV
><?php manualFooter('msql_fetch_field');?>