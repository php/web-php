...
setupNavigation(array(
  ...
  'prev' => array('function.msql-numfields.php3', 'msql_numfields'),
  'next' => array('function.msql-pconnect.php3', 'msql_pconnect'),
...
><H2
>Description</H2
>int msql_numrows(void);<P
>  Identical to <A
HREF="function.msql-num-rows.php3"
>msql_num_rows</A
>.</P
></DIV
><?php manualFooter('msql_numrows');?>