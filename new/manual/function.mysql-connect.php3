...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-close.php3', 'mysql_close'),
  'next' => array('function.mysql-create-db.php3', 'mysql_create_db'),
...
><H2
>Description</H2
>int mysql_connect(string hostname, string username, string password);<P
...
>.</P
></DIV
><?php manualFooter('mysql_connect');?>