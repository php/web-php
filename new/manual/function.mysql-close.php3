...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-affected-rows.php3', 'mysql_affected_rows'),
  'next' => array('function.mysql-connect.php3', 'mysql_connect'),
...
><H2
>Description</H2
>int mysql_close(int link_identifier);<P
