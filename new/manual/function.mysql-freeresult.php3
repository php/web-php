...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-fieldlen.php3', 'mysql_fieldlen'),
  'next' => array('function.mysql-insert-id.php3', 'mysql_insert_id'),
...
><H2
>Description</H2
>int mysql_freeresult(int result);<P
...
></DIV
><?php manualFooter('mysql_freeresult');?>