...
setupNavigation(array(
  ...
  'prev' => array('function.fileowner.php3', 'fileowner'),
  'next' => array('function.filesize.php3', 'filesize'),
...
manualHeader('fileperms');
?><H1
>fileperms</H1
><P
>fileperms -- get file permissions</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int fileperms(string filename);<P
>    Returns the permissions on the file, or false in case of an error.
  
   </P
></DIV
><?php manualFooter('fileperms');?>