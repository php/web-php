...
setupNavigation(array(
  ...
  'prev' => array('function.chown.php3', 'chown'),
  'next' => array('function.fclose.php3', 'fclose'),
...
manualHeader('clearstatcache');
?><H1
>clearstatcache</H1
><P
>clearstatcache -- clear file stat cache</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>void clearstatcache(void);<P
...
></DIV
><?php manualFooter('clearstatcache');?>