...
setupNavigation(array(
  ...
  'prev' => array('function.log10.php3', 'Log10'),
  'next' => array('function.min.php3', 'min'),
...
>max</H1
><P
>max -- find highest value</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>mixed max(mixed arg1, mixed arg2, mixed argn);<P
>     Max() returns the numerically highest of the parameter values.

    </P
><P
>     If the first parameter is an array, max() returns the highest
     value in that array.  If the first parameter is an integer,
     string or double, you need at least two parameters and max()
