...
setupNavigation(array(
  ...
  'prev' => array('function.msql-fieldflags.php3', 'msql_fieldflags'),
  'next' => array('function.msql-freeresult.php3', 'msql_freeresult'),
...
manualHeader('msql_fieldlen');
?><H1
>msql_fieldlen</H1
><P
>msql_fieldlen -- get field length</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
...
></DIV
><?php manualFooter('msql_fieldlen');?>