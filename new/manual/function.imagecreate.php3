...
setupNavigation(array(
  ...
  'prev' => array('function.imagecopyresized.php3', 'ImageCopyResized'),
  'next' => array('function.imagecreatefromgif.php3', 'ImageCreateFromGif'),
...
manualHeader('ImageCreate');
?><H1
>ImageCreate</H1
><P
>ImageCreate -- create a new image</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int imagecreate(int x_size, int y_size);<P
>    ImageCreate returns an image identifier representing a blank image
    of size x_size by y_size.
   </P
></DIV
><?php manualFooter('ImageCreate');?>