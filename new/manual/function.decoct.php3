...
setupNavigation(array(
  ...
  'prev' => array('function.dechex.php3', 'DecHex'),
  'next' => array('function.exp.php3', 'Exp'),
...
>DecOct</H1
><P
>DecOct -- decimal to octal</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>string decoct(int number);<P
>     Returns a string containing an octal representation of the given
     ...
     2147483647 in decimal resulting to "17777777777". See also <A
