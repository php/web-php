...
setupNavigation(array(
  ...
  'prev' => array('function.msql-num-fields.php3', 'msql_num_fields'),
  'next' => array('function.msql-numfields.php3', 'msql_numfields'),
...
></DIV
><?php manualFooter('msql_num_rows');?>