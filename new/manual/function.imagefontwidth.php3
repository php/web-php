...
setupNavigation(array(
  ...
  'prev' => array('function.imagefontheight.php3', 'ImageFontHeight'),
  'next' => array('function.imagegif.php3', 'ImageGif'),
...
manualHeader('ImageFontWidth');
?><H1
>ImageFontWidth</H1
><P
>ImageFontWidth -- get font width</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int imagefontwidth(int font);<P
...
></DIV
><?php manualFooter('ImageFontWidth');?>