...
setupNavigation(array(
  ...
  'prev' => array('function.imagecolorallocate.php3', 'ImageColorAllocate'),
  'next' => array('function.imagecopyresized.php3', 'ImageCopyResized'),
...
manualHeader('ImageColorTransparent');
?><H1
>ImageColorTransparent</H1
><P
>ImageColorTransparent -- define a color as transparent</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int imagecolortransparent(int im, int col);<P
>    ImageColorTransparent sets the transparent color in the im image
    to col.  im is the image identifier returned by <A
...
></DIV
><?php manualFooter('ImageColorTransparent');?>