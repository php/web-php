...
setupNavigation(array(
  ...
  'prev' => array('function.filesize.php3', 'filesize'),
  'next' => array('function.fileumask.php3', 'fileumask'),
...
manualHeader('filetype');
?><H1
>filetype</H1
><P
>filetype -- get file type</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>string filetype(string filename);<P
