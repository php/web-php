...
setupNavigation(array(
  ...
  'prev' => array('function.odbc-close-all.php3', 'odbc_close_all'),
  'next' => array('function.odbc-connect.php3', 'odbc_connect'),
...
manualHeader('odbc_commit');
?><H1
>odbc_commit</H1
><P
>odbc_commit -- Commit an ODBC transaction</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
