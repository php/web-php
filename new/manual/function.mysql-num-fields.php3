...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-listtables.php3', 'mysql_listtables'),
  'next' => array('function.mysql-num-rows.php3', 'mysql_num_rows'),
...
manualHeader('mysql_num_fields');
?><H1
>mysql_num_fields</H1
><P
>mysql_num_fields -- get number of fields in result</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
