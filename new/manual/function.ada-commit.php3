...
setupNavigation(array(
  ...
  'prev' => array('function.ada-close.php3', 'ada_close'),
  'next' => array('function.ada-connect.php3', 'ada_connect'),
...
><H2
>Description</H2
>int ada_commit(int connection_id);<P
>Returns:   TRUE on success, FALSE on failure.
 
 All pending statements on connection_id are committed.
   </P
></DIV
><?php manualFooter('ada_commit');?>