...
setupNavigation(array(
  ...
  'prev' => array('function.ldap-get-values.php3', 'ldap_get_values'),
  'next' => array('function.ldap-modify.php3', 'ldap_modify'),
