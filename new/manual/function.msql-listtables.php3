...
setupNavigation(array(
  ...
  'prev' => array('function.msql-listdbs.php3', 'msql_listdbs'),
  'next' => array('function.msql-num-fields.php3', 'msql_num_fields'),
...
></DIV
><?php manualFooter('msql_listtables');?>