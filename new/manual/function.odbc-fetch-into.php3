...
setupNavigation(array(
  ...
  'prev' => array('function.odbc-execute.php3', 'odbc_execute'),
  'next' => array('function.odbc-fetch-row.php3', 'odbc_fetch_row'),
...
manualHeader('odbc_fetch_into');
?><H1
>odbc_fetch_into</H1
><P
>odbc_fetch_into -- Fetch one result row into array</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
