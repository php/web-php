...
setupNavigation(array(
  ...
  'prev' => array('function.chmod.php3', 'chmod'),
  'next' => array('function.clearstatcache.php3', 'clearstatcache'),
...
>chown</H1
><P
>chown -- change file owner</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int chown(string filename, mixed user);<P
...
><B
>NOTE: </B
>On Windows, does nothing and returns true.</P
></BLOCKQUOTE
>
