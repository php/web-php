...
setupNavigation(array(
  ...
  'prev' => array('function.ldap-count-entries.php3', 'ldap_count_entries'),
  'next' => array('function.ldap-first-attribute.php3', 'ldap_first_attribute'),
...
manualHeader('ldap_delete');
?><H1
>ldap_delete</H1
><P
>ldap_delete -- Delete an entry in a directory</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
