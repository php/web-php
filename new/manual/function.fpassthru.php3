...
setupNavigation(array(
  ...
  'prev' => array('function.fopen.php3', 'fopen'),
  'next' => array('function.fputs.php3', 'fputs'),
...
manualHeader('fpassthru');
?><H1
>fpassthru</H1
><P
>fpassthru -- output all remaining data on a file pointer</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int fpassthru(int fp);<P
