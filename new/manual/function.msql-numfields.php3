...
setupNavigation(array(
  ...
  'prev' => array('function.msql-num-rows.php3', 'msql_num_rows'),
  'next' => array('function.msql-numrows.php3', 'msql_numrows'),
...
manualHeader('msql_numfields');
?><H1
>msql_numfields</H1
><P
>msql_numfields -- get number of fields in result</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int msql_numfields(void);<P
>  Identical to <A
HREF="function.msql-num-fields.php3"
>msql_num_fields</A
>.</P
></DIV
><?php manualFooter('msql_numfields');?>