...
setupNavigation(array(
  ...
  'prev' => array('function.chgrp.php3', 'chgrp'),
  'next' => array('function.chown.php3', 'chown'),
...
>chmod</H1
><P
>chmod -- change file mode</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int chmod(string filename, int mode);<P
