...
setupNavigation(array(
  ...
  'prev' => array('function.msql-close.php3', 'msql_close'),
  'next' => array('function.msql-create-db.php3', 'msql_create_db'),
...
manualHeader('msql_connect');
?><H1
>msql_connect</H1
><P
>msql_connect -- open mSQL connection</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int msql_connect(string hostname);<P
>     Returns a positive mSQL link identifier on success, or false on error.
    </P
><P
>  msql_connect() establishes a connection to a mSQL server.
  The hostname argument is optional, and if it's missing, localhost
  is assumed.
