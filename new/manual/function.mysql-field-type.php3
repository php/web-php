...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-field-table.php3', 'mysql_field_table'),
  'next' => array('function.mysql-fieldflags.php3', 'mysql_fieldflags'),
...
><H2
>Description</H2
>string mysql_field_type(string result, int i);<P
>   mysql_field_type is similar to the <A
...
></DIV
><?php manualFooter('mysql_field_type');?>