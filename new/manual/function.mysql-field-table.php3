...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-field-seek.php3', 'mysql_field_seek'),
  'next' => array('function.mysql-field-type.php3', 'mysql_field_type'),
...
manualHeader('mysql_field_table');
?><H1
...
><H2
>Description</H2
>int mysql_field_table(void);<P
>    Another new function in PHP 3. This function is listed in
    PHPFUNCTIONS as mysql_fieldtable!!!
  </P
></DIV
><?php manualFooter('mysql_field_table');?>