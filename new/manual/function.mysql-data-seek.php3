...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-createdb.php3', 'mysql_createdb'),
  'next' => array('function.mysql-dbname.php3', 'mysql_dbname'),
...
><H2
>Description</H2
>int mysql_data_seek(int result_identifier, int row_number);<P
...
></P
></DIV
><?php manualFooter('mysql_data_seek');?>