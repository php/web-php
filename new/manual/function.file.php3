...
setupNavigation(array(
  ...
  'prev' => array('function.fgetss.php3', 'fgetss'),
  'next' => array('function.fileatime.php3', 'fileatime'),
...
>file</H1
><P
>file -- read entire file into an
    array</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>array file(string filename);<P
> Identical to <A
