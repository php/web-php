...
setupNavigation(array(
  ...
  'prev' => array('function.imagegif.php3', 'ImageGif'),
  'next' => array('function.imageline.php3', 'ImageLine'),
...
manualHeader('ImageInterlace');
?><H1
>ImageInterlace</H1
><P
>ImageInterlace -- enable or disable interlace</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int imageinterlace(int im, int interlace);<P
>    ImageInterlace turns the interlace bit on or off.  If interlace is
    1 the im image will be interlaced, and if interlace is 0 the
    interlace bit is turned off.
   </P
></DIV
><?php manualFooter('ImageInterlace');?>