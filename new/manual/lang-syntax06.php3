...
setupNavigation(array(
  ...
  'prev' => array('lang-syntax05.php3', 'Variable Scope'),
  'next' => array('lang-syntax07.php3', 'Variables from outside PHP'),
...
manualHeader('Variable variables');
?><H1
><A
NAME="I(LANG-SYNTAX)C(6,SECT1)"
>Variable variables</A
></H1
><P
></P
><?php manualFooter('Variable variables');?>