...
setupNavigation(array(
  ...
  'prev' => array('ref.adabas.php3', 'Adabas D Functions'),
  'next' => array('function.ada-autocommit.php3', 'ada_autocommit'),
...
><H2
>Description</H2
>int ada_afetch(int result_id, int rownumber, array result_array);<P
>     Returns the number of columns in the result; FALSE on error.
   </P
></DIV
><?php manualFooter('ada_afetch');?>