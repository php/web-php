...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-list-fields.php3', 'mysql_list_fields'),
  'next' => array('function.mysql-listtables.php3', 'mysql_listtables'),
...
><H2
>Description</H2
>int mysql_listdbs(void);<P
>     mysql_listdbs will return a result pointer containing the
     databases available from the current mysql daemon. Use the <A
...
></DIV
><?php manualFooter('mysql_listdbs');?>