...
setupNavigation(array(
  ...
  'prev' => array('function.ada-numfields.php3', 'ada_numfields'),
  'next' => array('function.ada-result.php3', 'ada_result'),
...
><H2
>Description</H2
>int ada_numrows(int result_id);<P
>Returns:   ada_numrows will return the number of rows in an Adabas result.
