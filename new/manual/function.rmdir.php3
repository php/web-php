...
setupNavigation(array(
  ...
  'prev' => array('function.rewind.php3', 'rewind'),
  'next' => array('function.stat.php3', 'stat'),
...
>rmdir</H1
><P
>rmdir -- remove directory</P
><DIV
CLASS="REFSECT1"
><H2
>Description</H2
>int rmdir(string dirname);<P
>    Attempts to remove the directory named by pathname. The
