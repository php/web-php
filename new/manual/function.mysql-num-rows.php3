...
setupNavigation(array(
  ...
  'prev' => array('function.mysql-num-fields.php3', 'mysql_num_fields'),
  'next' => array('function.mysql-numfields.php3', 'mysql_numfields'),
...
><H2
>Description</H2
>int mysql_num_rows(string result);<P
...
></DIV
><?php manualFooter('mysql_num_rows');?>