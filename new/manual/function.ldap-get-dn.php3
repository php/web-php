...
setupNavigation(array(
  ...
  'prev' => array('function.ldap-get-attributes.php3', 'ldap_get_attributes'),
  'next' => array('function.ldap-get-entries.php3', 'ldap_get_entries'),
