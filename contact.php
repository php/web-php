...
<p>
 ...
 <ul>
  <li>
   <b>Requests for help with using PHP.</b> Please use the
      <a href="mailto:php-general@lists.php.net">PHP General</a> mailing list.
  </li>
  <li>
   <b>Source code to the PHP website(s) being publicly readable.</b>
      This is <i>on purpose</i>.
      All of the php.net websites are available publicly on github.
      For example, you can find this site at <a href="https://github.com/php/web-php">github.com/php/web-php</a>.
  </li>
  <li>
   <b>Requests for bug bounty payments.</b>
