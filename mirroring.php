...
<p>
 ...
 usage (a reasonable estimate as of September 2006 is 10GB/day, based on
 access data from uk.php.net). The PHP website requires at least PHP 4.3.x,
 but PHP 5 is preferred. Set it up as an Apache module with the settings
 <a href="#settings">outlined below</a>. The size of the full website is
 approximately 1.7 gigabyte.
</p>
