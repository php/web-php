...
<LI>Download a <A HREF="binaries.php3">binary distribution</a> of Apache+PHP for your favourite UNIX - experimental.
<LI>To download the latest development version, see the instructions on using the 
<a href="http://ca.php.net/cvsweb.cgi">PHP 3.0 CVS tree</a>.
