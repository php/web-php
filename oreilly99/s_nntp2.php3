...
<?$server="{news.php.net/nntp:119}";
  ...
  $header->Size."</td><td><a href=\"mailto: $addr\">$name</a></td>\n";
        ...
        echo "<table border=1>\n";
        echo "<tr><th align=left style='font-size:16pt'>From: </th><td>$name &lt;
  <a href=\"mailto: $addr\">$addr</a>&gt;</td></tr>\n";
        echo "<tr><th align=left style='font-size:16pt'>Subject:</th><td>". $header->Subject."</td>\n";
        echo "<tr><th align=left style='font-size:16pt'>Date: </th><td>".
  date("H:i:s M d/y",$header->udate+4*3600)." EDT</td></tr>\n";
        echo "<tr><td colspan=2 class=body><PRE style='font-size: 12pt'>";
