...
$books = array ( 
  ...
  "Other" => array(
   ...
   array("PHP Afterwork",    #title(s)
      "http://www.amazon.de/exec/obidos/ASIN/3815505178/wwwphpnet07", #title_link
      array("Mark Kronsbein", "Clemens Gutweiler", "Thomas Weinert", "Peter Petermann"), #author(s)
      array("http://www.zend.com/comm_person.php?id=36", false, false, "http://www.zend.com/comm_person.php?id=60"), #author_link(s)
      "afterworkphp.jpg", #img
      "Sybex, July 2001, ISBN 3-8155-0517-8, 352 pages", #info
      "http://www.phpbuch.de/", #info_link
      "de"  #lang
   ),
