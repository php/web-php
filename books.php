...
showBook( "PHP Pocket Reference",    #title(s)
...
showBook( "Professional PHP Programming",    #title(s)
...
showBook( array("Core PHP Programming", "Using PHP to Build Dynamic Web Sites"), #title(s)
...
showBook( "PHP3: Programming Browser-Based Applications",    #title(s)
...
showBook( "Building Database Applications on the Web Using PHP3",    #title(s)
...
showBook( array("PHP Essentials","A Better Way to Learn PHP - Includes Version 4"),  #title(s)
...
showBook( "PHP Fast & Easy Web Development",     #title(s)
...
showBook( "SAMS Teach Yourself PHP4 in 24 Hours",    #title(s)
...
showBook( "Web Application Development with PHP 4.0",    #title(s)
...
showBook( "PHP and MySQL Web Development",    #title(s)
...
showBook( "Essential PHP for Web Professionals",    #title(s)
...
showBook( "MySQL and PHP from Scratch",    #title(s)
...
showBook( "A Programmer's Introduction to PHP 4.0",    #title(s)
...
showBook( "PHP Developer's Cookbook",    #title(s)
...
showBook( "Beginning PHP 4",    #title(s)
...
showBook( "PHP Developer's Dictionary",    #title(s)
    "", #title_link
...
showBook( "PHP 4 Developer's Guide",    #title(s)
...
showBook( "MySQL/PHP Database Application",    #title(s)
...
showBook( "PHP Functions Essential Reference",    #title(s)
...
showBook( "PHP 4. Dynamische Webauftritte professionell realisieren",    #title(s)
...
showBook( "PHP - Dynamische websites professioneel ondersteunen",    #title(s)
...
showBook( array("PHP 4: Grundlagen und Profiwissen","Webserver-Programmierung unter Windows und Linux"),    #title(s)
...
showBook( array("PHP 4","Webserver-Programmierung f&uuml;r Um- und Einsteiger"),    #title(s)
...
showBook( "PHP 4 - Tutorial & Referenz",    #title(s)
...
showBook( "Jetzt lerne ich PHP 4",    #title(s)
...
showBook( "Webanwendungen mit PHP 4.0 entwickeln",    #title(s)
...
showBook( "PHP 4 f&uuml;r Profis. Werkzeugkiste und Kochbuch",    #title(s)
...
showBook( "Pages Web dynamiques avec ASP, PHP, SQL",    #title(s)
...
showBook( "Programmation PHP",    #title(s)
...
showBook( "Programmation Web avec PHP",    #title(s)
...
showBook( array("PHP tvorba interaktivnich internetovych aplikaci", "(PHP development interactive internet applications)"),    #title(s)
...
showBook( "PHP Web-DB Programming Guide",    #title(s)
...
showBook( "PHP Web Programming with ORACLE Database",    #title(s)
...
showBook( array("Using PHP and MySQL", "With FreeBSD and Apache"),    #title(s)
...
showBook( "Examples of PHP and MySQL",    #title(s)
...
showBook( "PHP tettei kouryaku",    #title(s)
...
showBook( "PHP Guia de Consulta R&aacute;pida",    #title(s)
...
showBook( array("Scriptsprachen f&uuml;r dynamische Webauftritte", "JavaScript, VBScript, ASP, Perl, PHP, XML"),   #title(s)
...
showBook( "PostgreSQL: Introduction and Concepts",    #title(s)
...
showBook( "MySQL and mSQL (Nutshell Series)",    #title(s)
...
showBook( "Webmaster in a Nutshell (Nutshell Series)",    #title(s)
...
showBook( array("Open Source Development with CVS","Learn how to work with Open Source Software"),    #title(s)
...
showBook( "CVS Pocket Reference",    #title(s)
...
showBook( "Mastering Regular Expressions",    #title(s)
