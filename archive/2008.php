...
<div class="newsItem hentry">
    ...
    <div class="entry-content description">
        ...
        <p>If anyone is interested in the project please join the <a href="mailto:internals-win@lists.php.net">PHP Windows Development</a> <a href="https://php.net/mailinglist">mailinglist</a>.</p>
...
<div class="newsItem hentry">
    ...
    <div class="entry-content description">
        ...
        Several new features have already been documented in the <a href="https://php.net/docs.php">official documentation</a>,
        ...
        Please also review the <a href="https://php.net/php5news">NEWS</a> file.</p>
        ...
        <ul>
          <li><a href="https://php.net/language.namespaces">Namespaces</a> (documentation has been updated to the current state)</li>
          <li>
...
<div class="newsItem hentry">
    ...
    <div class="entry-content description">
        ...
        <ul>
          ...
          <li><a href="https://php.net/language.namespaces">Namespaces</a> (documentation maybe out dated)</li>
          <li><a href="https://php.net/oop5.late-static-bindings">Late static binding</a> and <a href="https://php.net/language.oop5.overloading">__callStatic</a></li>
          <li>
            <a href="https://wiki.php.net/rfc/closures">Lambda functions and closures</a>
          </li>

          <li>Addition of the <a href="https://php.net/book.intl">intl</a>, <a href="https://php.net/book.phar">phar</a> (phar is scheduled for some more work a head of alpha2), <a href="https://php.net/book.fileinfo">fileinfo </a> and <a href="https://php.net/book.sqlite3">sqlite3</a> extensions</li>
          ...
          <li>New syntax features like <a href="https://php.net/language.types.string#language.types.string.syntax.nowdoc">NOWDOC</a>, limited GOTO, ternary short cut "?:"</li>
        </ul>
...
<div class="newsItem hentry">
    ...
    <div class="entry-content description">
        ...
        <p>We would like to take this opportunity to say thanks to Google Inc. for this privilege to participate once again, and would like to invite everyone to look at our list of ideas: <a href="https://wiki.php.net/gsoc/2008">http://wiki.php.net/gsoc/2008</a>. Students are of course more than welcome to come up with their own ideas for their proposals and we will consider each and every application that we will receive.</p>
