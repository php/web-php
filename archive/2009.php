...
<div class="newsItem hentry vevent">
    ...
    <h1 class="summary entry-title"><a id="id2009-12-09-1" href="http://www.phpconference.co.uk/" rel="bookmark" class="bookmark">PHP UK Conference 2010</a></h1>
    <div class="entry-content description">
...
<div class="newsItem hentry">
    ...
    <div class="entry-content description">
      ...
      <p>Further details about the PHP 5.3.1 release can be found in the <a href="https://www.php.net/releases/5_3_1.php">release announcement</a>, and the full list of changes are available in the <a href="http://www.php.net/ChangeLog-5.php#5.3.1">ChangeLog</a>.</p>
    </div>
...
<div class="newsItem hentry vevent">
    ...
    <h1 class="summary entry-title"><a id="id2009-10-21-1" href="http://www.phpconference.com/" rel="bookmark" class="bookmark">International PHP Conference</a></h1>
    <div class="entry-content description">
...
<div class="newsItem hentry vevent">
    ...
    <h1 class="summary entry-title"><a id="id2009-10-01-1" href="http://www.phpworld-kongress.de" rel="bookmark" class="bookmark">PHP World Kongress</a></h1>
    <div class="entry-content description">
...
<div class="newsItem hentry vevent">
    ...
    <h1 class="summary entry-title"><a id="id2009-09-28-1" href="http://phpconference.es/" rel="bookmark" class="bookmark">PHP Barcelona Conference 2009</a></h1>
    <div class="entry-content description">
...
<div class="newsItem hentry vevent">
    ...
    <h1 class="summary entry-title"><a id="id2009-08-26-1" href="http://zendcon.com" rel="bookmark" class="bookmark">ZendCon 2009!</a></h1>
    <div class="entry-content description">
...
<div class="newsItem hentry vevent">
    ...
    <h1 class="summary entry-title"><a id="id2009-07-21-1" href="http://conference.phpnw.org.uk/" rel="bookmark" class="bookmark">PHP North West Conference</a></h1>
    <div class="entry-content description">
...
<div class="newsItem hentry">
    ...
    <div class="entry-content description">
     ...
     <p>
      ...
      <a href="https://php.net/svn.php">php.net/svn.php</a>,
...
<div class="newsItem hentry">
    ...
    <div class="entry-content description">
     ...
     <p>
      ...
      submitting new tests to the <a href="https://php.net/mailinglists">QA mailing list</a>,
      or, if you have written a significant number of tests you might
      consider applying for your own
      <a href="https://php.net/cvs-php">PHP CVS (or SVN) ID</a>.
...
<div class="newsItem hentry">
    ...
    <div class="entry-content description">
     ...
     <p>
      ...
      <a href="https://php.net/downloads.php#v5.3.0">5.3.0</a>.
     ...
     <p>
      ...
      <a href="https://php.net/namespaces">namespaces</a>,
      <a href="https://php.net/lsb">late static binding</a>,
      <a href="https://php.net/closures">closures</a>,
      optional <a href="https://php.net/gc_enable">garbage collection</a> for cyclic references,
      new extensions (like <a href="https://php.net/phar">ext/phar</a>,
      <a href="https://php.net/intl">ext/intl</a> and
      <a href="https://php.net/fileinfo">ext/fileinfo</a>),
      over 140 bug fixes and much more.
     </p>

     <p>
      For users upgrading from PHP 5.2 there is a
      <a href="https://php.net/migration53">migration guide</a>
      available here, detailing the changes between those
      releases and <a href="https://php.net/downloads.php#v5.3.0">PHP 5.3.0</a>.
     </p>

     <p>
      Further details about the
      <a href="https://php.net/downloads.php#v5.3.0">PHP 5.3.0</a> release
      can be found in the
      <a href="https://php.net/releases/5_3_0.php">release announcement</a>,
      and the full list of changes are available in the
      <a href="https://php.net/ChangeLog-5.php">ChangeLog</a>.
     </p>
...
<div class="newsItem hentry">
    ...
    <div class="entry-content description">
     ...
     <p>
      ...
      <a href="https://php.net/namespaces">namespaces</a>,
      <a href="https://php.net/lsb">late static binding</a>,
      <a href="https://php.net/closures">closures</a> and much more.
     </p>
     <p>
...
<div class="newsItem hentry vevent">
    ...
    <h1 class="summary entry-title"><a id="id2009-06-03-1" href="http://cw.mtacon.com/" rel="bookmark" class="bookmark">CodeWorks Conference</a></h1>
    <div class="entry-content description">
...
<div class="newsItem hentry vevent">
    ...
    <h1 class="summary entry-title"><a id="id2009-05-29-1" href="http://www.afup.org/" rel="bookmark" class="bookmark">Forum PHP Paris 2009</a></h1>
    <div class="entry-content description">
...
<div class="newsItem hentry vevent">
    ...
    <h1 class="summary entry-title"><a id="id2009-04-17-1" href="http://www.phpday.it/" rel="bookmark" class="bookmark">phpDay Italy</a></h1>
    <div class="entry-content description">
...
<div class="newsItem hentry vevent">
    ...
    <h1 class="summary entry-title"><a id="id2009-04-06-1" href="http://phpconference.nl/" rel="bookmark" class="bookmark">DPC09</a></h1>
    <div class="entry-content description">
...
<div class="newsItem hentry">
    ...
    <div class="entry-content description">
      ...
      <ul>
        <li>Support for <a href="https://php.net/namespaces">namespaces</a></li>
        <li>Under the hood performance improvements</li>
        <li><a href="https://php.net/lsb">Late static binding</a></li>
        <li><a href="https://docs.php.net/functions.anonymous">Lambda functions and closures</a></li>
        <li>
         Syntax additions:
         <a href="https://php.net/manual/language.types.string.php#language.types.string.syntax.nowdoc">NOWDOC</a>, limited GOTO,
         <a href="https://php.net/ternary#language.operators.comparison.ternary">ternary short cut "?:"</a> and
         <a href="https://php.net/__callstatic">__callStatic()</a>
        </li>
        <li>Optional <a href="https://php.net/gc_enable">garbage collection</a> for cyclic references</li>
        <li>Optional <a href="https://php.net/mysqli.mysqlnd">mysqlnd</a> PHP native replacement for libmysql</li>
        ...
        <li>Several enhancements to enable more <a href="https://php.net/ini.sections">flexiblity in php.ini</a> (and ini parsing in general)</li>
        <li>New bundled extensions:
         <a href="https://php.net/phar">ext/phar</a>,
         <a href="https://php.net/intl">ext/intl</a>,
         <a href="https://php.net/fileinfo">ext/fileinfo</a>,
         <a href="https://php.net/sqlite3">ext/sqlite3</a>,
         <a href="https://php.net/enchant">ext/enchant</a>
        </li>
        <li>Countless bug fixes and improvements to existing extensions in particular to:
         <a href="https://php.net/openssl">ext/openssl</a>,
         <a href="https://php.net/spl">ext/spl</a> and
         <a href="https://php.net/datetime">ext/date</a>
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>Removed the following extensions:
         <a href="https://php.net/mhash">ext/mhash</a> (see <a href="https://php.net/hash">ext/hash</a>),
         <a href="https://php.net/msql">ext/msql</a>,
         <a href="https://php.net/pspell">ext/pspell</a> (see <a href="https://php.net/enchant">ext/enchant</a>),
         <a href="https://php.net/sybase">ext/sybase</a> (see <a href="https://php.net/sybase">ext/sybase_ct</a>)
        </li>
        <li>Moved the following extensions to PECL:
         <a href="https://php.net/ming">ext/ming</a>,
         <a href="https://php.net/fbsql">ext/fbsql</a>,
         <a href="https://php.net/ncurses">ext/ncurses</a>,
         <a href="https://php.net/fdf">ext/fdf</a>
        </li>
        <li>Removed <a href="https://php.net/manual/ini.core.php#ini.zend.ze1-compatibility-mode">zend.ze1_compatibility_mode</a></li>
...
<div class="newsItem hentry">
    ...
    <div class="entry-content description">
      ...
      <p>Further details about the PHP 5.2.9 can be found in the release announcement for <a href="https://www.php.net/releases/5_2_9.php">5.2.9</a>  the full list of changes is available in the <a href="http://www.php.net/ChangeLog-5.php#5.2.9">ChangeLog for PHP 5</a>.</p>
    </div>
