...
<h1>PHP.net: A Tourist's Guide<br />
<small>originally by Damien Seguy</small></h1>

<p>Everyone knows the www.php.net site. All of us went there sooner or later,
...
<p>
The next most visited section is the <a href="/docs.php">documentation</a>. The
...
<h2><a href="http://news.php.net/">news.php.net</a>: Mailing Lists Web and NNTP Interface</h2>
<p>
...
<h2><a href="http://pear.php.net/">pear.php.net</a>: The PHP Extension and Application Repository</h2>
<p>
...
the ultimate tool for exploring PHP code. Browse inside the latest PHP code,
and anytime important macro and or function are detected within the code, they
are linked to their definition, and all their usage locations. This will help
...
build graphical interfaces, with slick interface and highly interactive
content. You'll find the downloads and docs here, and the latest news from
the project.
</p>
