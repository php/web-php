...
$external_redirects = array(
    "php4news"    => "https://github.com/php/php-src/blob/PHP-4.4/NEWS",
    "php5news"    => "https://github.com/php/php-src/blob/PHP-5.6/NEWS",
    "php53news"   => "https://github.com/php/php-src/blob/PHP-5.3/NEWS",
    "php54news"   => "https://github.com/php/php-src/blob/PHP-5.4/NEWS",
    "php55news"   => "https://github.com/php/php-src/blob/PHP-5.5/NEWS",
    "php56news"   => "https://github.com/php/php-src/blob/PHP-5.6/NEWS",
    "php70news"   => "https://github.com/php/php-src/blob/PHP-7.0/NEWS",
    "php71news"   => "https://github.com/php/php-src/blob/PHP-7.1/NEWS",
    "php72news"   => "https://github.com/php/php-src/blob/PHP-7.2/NEWS",
    "php73news"   => "https://github.com/php/php-src/blob/PHP-7.3/NEWS",
    "phptrunknews"=> "https://github.com/php/php-src/blob/master/NEWS",
